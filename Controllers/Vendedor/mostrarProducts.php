        ...
        if (!isset($result)) {
            ...
            foreach ($result as $f) {
                ...
                <tr class="center-div-bar">
                    ...
                    <td style="color: #000!important;text-align: center; font-family: Arial, Helvetica, sans-serif;" > <a href="../../Controllers/Vendedor/eliminarProduct.php?id_pro='.$f['id_pro'].'" class="btn btn-danger" style="font-family: Arial, Helvetica, sans-serif; display: -webkit-inline-box;" ><i class="ti-trash"> </i><p style="margin: 0; color: #fff;">ㅤELIMINAR</p></a></td>
                </tr>
                ';
            }
        }
