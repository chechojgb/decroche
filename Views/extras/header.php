                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="./categoria/ropa/ropa.php" class="dropdown-item">Ropa</a>
                                    <a href="./categoria/lanas/lana.php" class="dropdown-item">Lana</a>
                                    <a href="./categoria/costura/costura.php" class="dropdown-item">Articulos de costura</a>
                                    <a href="./categoria/patrones/patrones.php" class="dropdown-item">Patrones</a>
                                </div>
                            </div>
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            <a href="./mostrarCarrito.php" class="position-relative me-4 my-auto">
                                ...
                                <span class="position-absolute bg-secondary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style="top: -5px; left: 15px; height: 20px; min-width: 20px; color: #fff !important; background: #e08eb1 !important;"><?php 
                    ...
                    ?></span>
                                ...
                                // Verifica si la sesión está iniciada
                                  ...
                                  cargarPerfil3();
                                      ...
                                      // Si la sesión no está iniciada, muestra el ícono de inicio de sesión
                                      echo '<a href="./page-login.php" class="my-auto"><i class="fas fa-user fa-2x" style="color: #e08eb1"></i></a>';
                                  }
                                ?>
                ...
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body  align-items-center">
                      <div class="input-group w-75 mx-auto d-flex" id="buscar_producto_nav">
                        ...
                        <input type="search" class="form-control p-3" placeholder="Para buscar oprime el boton" aria-describedby="search-icon-1" id="buscarProducto_a" >
