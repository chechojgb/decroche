...
<div id="spinner" class="show w-100 vh-100 bg-white position-fixed translate-middle top-50 start-50  d-flex align-items-center justify-content-center">
                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="./costura.php" class="dropdown-item">Articulos de costura</a>
                                    <a href="../patrones/patrones.php" class="dropdown-item">Patrones</a>
                                </div>
                            </div>
        ...
        <div class="container-fluid fruite py-5" style="margin-top: 70px;" >
            <div class="container py-5">
                <h1 class="mb-4">Seccion de articulos de costura</h1>
                <div class="row g-4">
                    <div class="col-lg-12">
                        ...
                        <div class="row g-4">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="./costura.php"><i class="fas fa-star  me-2"></i>Articulos de costura</a>
                                                        <span>(2)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="../patrones/patrones.php"><i class="fas fa-star  me-2"></i>Patrones</a>
                                                        <span>(8)</span>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="col-lg-9">
                                <div class="row g-4 justify-content-center">
                                  <?php 
                                  cargarProductosCategoriaCostura();
                                  ?>
                                    <div class="col-12">
