...
<div id="spinner" class="show w-100 vh-100 bg-white position-fixed translate-middle top-50 start-50  d-flex align-items-center justify-content-center">
                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="./ropa.php" class="dropdown-item">Ropa</a>
        ...
        <div class="container-fluid fruite py-5" style="margin-top: 70px;" >
            <div class="container py-5">
                <h1 class="mb-4">Seccion de ropa de lana</h1>
                <div class="row g-4">
                    <div class="col-lg-12">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                <li class="">
                                                    <div class="d-flex justify-content-between fruite-name active">
                                                        <a href="./ropa.php"><i class="fas fa-star  me-2"></i>Ropa de lana</a>
                                                        <span>(3)</span>
                                                    </div>
                                                </li>
                                                <li>
