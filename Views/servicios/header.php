                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            // Verifica si la sesión está iniciada
                              if (isset($_SESSION['id']) && !empty($_SESSION['id'])) {
                                echo '<a style="display:none;" href="../extras/page-login.php" class="nav-item nav-link">Ingresa</a>';
                              } else {
                                echo '<a href="../extras/page-login.php" class="nav-item nav-link">Ingresa</a>';
                            ...
                            <a href="./servicios.php" class="nav-item nav-link active" >Nuestros servicios</a>
                            <div class="nav-item dropdown">
                        ...
                        <div class="d-flex m-3 me-0">
                            ...
                            // Verifica si la sesión está iniciada
                              if (isset($_SESSION['id']) && !empty($_SESSION['id'])) {
                                ...
                                echo '<button class="btn-search btn border border-secondary btn-md-square rounded-circle bg-white me-4" data-bs-toggle="modal" data-bs-target="#searchModal" style="margin-top: 0px!important;" ><i class="fas fa-search text-primary"></i></button>';
                                  // Si la sesión no está iniciada, muestra el ícono de inicio de sesión
                              }
                            ?>
                    ...
                    ?></span>
                                ...
                                // Verifica si la sesión está iniciada
                                  ...
                                  cargarPerfil3();
                                      ...
                                      // Si la sesión no está iniciada, muestra el ícono de inicio de sesión
                                      echo '<a href="../extras/page-login.php" class="my-auto"><i class="fas fa-user fa-2x"></i></a>';
                                  }
                                ?>
