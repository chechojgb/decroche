...
<div class="contenedor-formulario" style="margin-top: 150px;" >
  ...
  <main class="contenedor-formulario-content">
    ...
    <section class="section-principal-formulario">
      ...
      <form action="../../Controllers/servicios/registrarPeticion.php" method="post" id="envioPeticion" enctype="multipart/form-data">
        ...
        <div class="enviar_radicadop" style="margin: 25px 10px; ">
          <button type="button" onclick="registrarPeticion()" class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4" >Enviar petición</button>
        </div>
