            ...
            <form id="form_editar_servicios" method="post">
                <table class="table table-bordered table-hover form-edit" style="border: 8px solid #dee2e6;">
                    ...
                    <tbody class="form-edit">
                        <tr>
                            <h2 colspan="2" style="text-align: center; margin: 30px 0 50px;">Editar Producto</h2>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><label for="proveedor">Precio:</label></td>
                            <td><input type="text" id="precio" name="precio"></td>
                        </tr>
                        <tr>
                            <td><label for="estado">Proveedor:</label></td>
                            <td><input type="text" id="proveedor" name="proveedor" readonly></td>
                        </tr>
                        <tr>
                            <td><label for="categoria">Categoria:</label></td>
                                <td><select   name="categoria" required id="categoria" style="width: -webkit-fill-available; padding: 10px;">
                        ...
                        <tr>
                            ...
                            <td><select class=""  name="estado" id="estados" style="width: -webkit-fill-available; padding: 10px;" id="detalle">
