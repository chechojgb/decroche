...
>
                            ...
                            <div class="row">
                                <form action="../../Controllers/registroUserExterno.php" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" style="background: #c96691; color: #fff; margin-left: 45%; height:50px; font-size: 17px;">Crear nuevo usuario</button>
                            </form>
                            </div>
                            </form>
                                    </div>
