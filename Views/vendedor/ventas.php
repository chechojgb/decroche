<?php
    ...
    require_once("../../Controllers/Vendedor/totalProducto.php");
...
<head>
    ...
    <title>Ventas Vendedor - DeCroche</title>
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola, <span>Bienvenido al exportador de archivos de datos de ventas</span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                            <thead>
                                                <tr style="background: #e08eb1;" class="center-div-bar">
                                                    ...
                                                    <th style="color: #fff;">ventas totales</th>
                                                    <th style="color: #fff; text-align:center;">Ganancia total</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php
